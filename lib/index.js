...
* @param {Function} geocodeRequest A function that take a object containing the query text, current map bounds, and options.  It returns a promise with an array of result.  A result should look like something like this: { "name": "Denver", "lat": 39.742043, "lon": -104.991531, "bbox": ["39.6143154","39.9142087","-105.1098845","-104.5996889"]}
* @example
...
MapboxGenericGeocoder.prototype = {
	...
	_onChange: function() {
		...
		_geocode: function(searchInput) {
			...
			this.geocodeRequest(searchInput, this._map.getBounds(), this.options).then(function(response) {
				this._loadingEl.style.display = 'none';
				if (response.length) {
					response = response.slice(0, this.options.limit);
